...
pho_variables = [
      ...
      "passPreselection        := atLeastOneDiphoPass"
      # "logSumpt_zero           := logSumPt2_zero",
      # "ptAsym_zero             := ptAsym_zero",
      # "ptBal_zero              := ptBal_zero",
      # "pullConv_zero           := pullConv_zero",
      # "nConv_zero              := nConv_zero",
      # "logSumpt_hgg            := logSumPt2_hgg",
      # "ptAsym_hgg              := ptAsym_hgg",
      # "ptBal_hgg               := ptBal_hgg",
      # "pullConv_hgg            := pullConv_hgg",
      # "nConv_hgg               := nConv_hgg"
