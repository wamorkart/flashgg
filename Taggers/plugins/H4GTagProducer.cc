...
//cout << "********************************************" << endl;
              ...
              */
              ...
              //cout << "[TAGPRODUCER] central event weight : " << tag_obj.centralWeight() << endl;
              // check the prefire weight
              //cout << "prefireWeightCentral : " << tag_obj.weight("prefireWeight") << endl;
              //cout << "[TAGPRODUCER] prefireWeightUp01Sigma : " << tag_obj.weight("prefireWeightUp01sigma") << endl;
              //cout << "[TAGPRODUCER] prefireWeightDown01Sigma : " << tag_obj.weight("prefireWeightDown01sigma") << endl;
//cout << "******************************************************* " << endl;
//tag_obj.includeWeightsByLabel( *diphoVec[preselDiPhoIndex[0]] ,"PreselSF");
              //tag_obj.includeWeightsByLabel( *diphoVec[preselDiPhoIndex[0]] ,"TriggerWeight");
