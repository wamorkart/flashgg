...
if (customize.year == "2016"):
    ...
    if (customize.doH4GVertex == 0):
        process.source = cms.Source ("PoolSource",
            fileNames = cms.untracked.vstring("root://cms-xrd-global.cern.ch//store/group/phys_higgs/HiggsExo/H4Gamma/H4G_2018_Signal_fullStats/H4G_2018_Signal_fullStats/102X_mc-RunIIAutumn18/HAHMHToAA_AToGG_MA-60GeV_TuneCP5_PSweights_13TeV-madgraph_pythia8/H4G_2018_Signal_fullStats-102X_mc-RunIIAutumn18-v0-RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/200710_161701/0000/myMicroAODOutputFile_107.root"))
    else:
        process.source = cms.Source ("PoolSource",
            fileNames = cms.untracked.vstring("root://cms-xrd-global.cern.ch//store/group/phys_higgs/HiggsExo/H4Gamma/H4G_2018_Signal_fullStats/H4G_2018_Signal_fullStats/102X_mc-RunIIAutumn18/HAHMHToAA_AToGG_MA-60GeV_TuneCP5_PSweights_13TeV-madgraph_pythia8/H4G_2018_Signal_fullStats-102X_mc-RunIIAutumn18-v0-RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v2/200710_161701/0000/myMicroAODOutputFile_107.root"),
            secondaryFileNames = cms.untracked.vstring("root://cms-xrd-global.cern.ch//store/mc/RunIIAutumn18MiniAOD/HAHMHToAA_AToGG_MA-60GeV_TuneCP5_PSweights_13TeV-madgraph_pythia8/MINIAODSIM/102X_upgrade2018_realistic_v15-v2/240000/8503A2F5-BED8-5949-B843-8EE694C53E35.root")
            )
