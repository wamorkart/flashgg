...
#             "Mjj := dijet().M()"
        ...
        variables = [
            ...
            # "pho1_energy_beforeSnS := phoP4Corrected_dp[0].energyAtStep("initial")",
            # "pho2_energy_beforeSnS := phoP4Corrected_dp[1].energyAtStep("initial")",
            # "pho3_energy_beforeSnS := phoP4Corrected_dp[2].energyAtStep("initial")",
            # "pho4_energy_beforeSnS := phoP4Corrected_dp[3].energyAtStep("initial")"
            #"n_pho     := n_pho"
            # "dipho_pt := dipho.pt()"
