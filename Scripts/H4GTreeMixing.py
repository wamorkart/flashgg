...
if __name__ == '__main__':
  ...
  for evt in range(0, eventsToRun):
    ...
    treeSkimmer.cosThetaStarCS_dM[0] = abs(treeSkimmer.getCosThetaStar_CS(PP1, PP2))
    treeSkimmer.cosTheta_a1_dM[0] = abs(treeSkimmer.CosThetaAngles(PP1,PP2,pairedDiphos[0][1], pairedDiphos[1][1])[0])
    treeSkimmer.cosTheta_a2_dM[0] = abs(treeSkimmer.CosThetaAngles(PP1,PP2,pairedDiphos[0][1], pairedDiphos[1][1])[1])
