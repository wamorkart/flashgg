...
void optimize_cats(const int NCAT) {
	TString path="/eos/user/t/twamorka/h4g_fullRun2/noSystematics/2016/hadd/CatMVA_PhoMVA_KinVars/";
	TString outpath="//eos/user/t/twamorka/www/H4Gamma/Jul2020_TaggerPlots/CatBDT/23Jul2020_PhoMVA_KinVars/";
	...
	file_s->Add(path+"signal_m_60_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_60_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
	file_s->Add(path+"signal_m_55_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_55_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
	file_s->Add(path+"signal_m_50_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_50_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
	file_s->Add(path+"signal_m_45_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_45_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
	file_s->Add(path+"signal_m_40_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_40_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
	file_s->Add(path+"signal_m_35_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_35_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
	file_s->Add(path+"signal_m_30_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_30_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
	file_s->Add(path+"signal_m_25_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_25_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
	file_s->Add(path+"signal_m_20_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_20_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
	file_s->Add(path+"signal_m_15_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_15_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
	file_s->Add(path+"signal_m_10_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_10_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
	file_s->Add(path+"signal_m_5_transformedMVA.root/SUSYGluGluToHToAA_AToGG_M_5_TuneCUETP8M1_13TeV_pythia8_13TeV_H4GTag_0");
   ...
   sel.Form("%s",(selection_sig+Mgg_window).Data());
	...
	TFile *file_data =  TFile::Open(path+"data_2016_transformedMVA.root");
	...
	TH1F* hist_datamix = new TH1F("hist_datamix","hist_datamix",100,0,1);
	TH1F* hist_data = new TH1F("hist_data","hist_data",100,0,1);
	...
	TH1F *hist_B = new TH1F("hist_B","hist_B",30,xmin,xmax); //200 bins
   ...
   sel.Form("%s",(selection_bg+Mgg_window).Data());
	...
	// TH1F *hist_B_sideband = new TH1F("hist_B_sideband","hist_B_sideband",30,xmin,xmax); //200 bins
...
std::vector<double> significance_scans3;
	...
	ofstream out;
	out.open(s.Format("%soutput_txt/%s.txt",path.Data(),outname.Data()));
  ...
  string line;
  ifstream outfile(s.Format("%soutput_txt/%s.txt",path.Data(),outname.Data()));
  if (outfile.is_open()){
...
//	leg->AddEntry(hist_B_cut_tth,"ttH","L");
	...
	gPad->RedrawAxis();
	c1->Print(s.Format("%splots/%s.png",outpath.Data(),outname.Data()));
	c1->Print(s.Format("%splots/%s.pdf",outpath.Data(),outname.Data()));
...
//	frame3->SetYTitle("S/#sqrt{B_{#gamma#gamma}+B_{ttH}}");
	...
	// pave33.Draw("same");
	gPad->RedrawAxis();
	c2->Print(s.Format("%splots/significance_%s.pdf",outpath.Data(),outname.Data()));
	c2->Print(s.Format("%splots/significance_%s.png",outpath.Data(),outname.Data()));
	cout<<counter<<endl;
