...
//     }
//   }
  // flashgg::Photon pho1_tmp = phoVect[diphoton_pairing_indices_.at(0)];
  // flashgg::Photon pho2_tmp = phoVect[diphoton_pairing_indices_.at(1)];
  // flashgg::Photon pho3_tmp = phoVect[diphoton_pairing_indices_.at(2)];
  // flashgg::Photon pho4_tmp = phoVect[diphoton_pairing_indices_.at(3)];
  // if(pho1_tmp.pt() > pho2_tmp.pt()){
  //   dp1_pho1_ = pho1_tmp.p4();
  //   dp1_pho2_ = pho2_tmp.p4();
  //   dp1_ipho1_ = diphoton_pairing_indices_.at(0);
  //   dp1_ipho2_ = diphoton_pairing_indices_.at(1);
  // }else{
  //   dp1_pho1_ = pho2_tmp.p4();
  //   dp1_pho2_ = pho3_tmp.p4();
  //   dp1_ipho1_ = diphoton_pairing_indices_.at(1);
  //   dp1_ipho2_ = diphoton_pairing_indices_.at(0);
  // }
  // if(pho3_tmp.pt() > pho4_tmp.pt()){
  //   dp2_pho1_ = pho3_tmp.p4();
  //   dp2_pho2_ = pho4_tmp.p4();
  //   dp2_ipho1_ = diphoton_pairing_indices_.at(2);
  //   dp2_ipho2_ = diphoton_pairing_indices_.at(3);
  // }else{
  //   dp2_pho1_ = pho4_tmp.p4();
  //   dp2_pho2_ = pho3_tmp.p4();
  //   dp2_ipho1_ = diphoton_pairing_indices_.at(3);
  //   dp2_ipho2_ = diphoton_pairing_indices_.at(2);
  // }
  // auto dipho1 = pho1_tmp.p4() + pho2_tmp.p4();
  // auto dipho2 = pho3_tmp.p4() + pho4_tmp.p4();
