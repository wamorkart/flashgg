...
#process.GlobalTag = GlobalTag(process.GlobalTag,'','')
process.source = cms.Source("PoolSource",
                           fileNames=cms.untracked.vstring("/store/mc/RunIIFall17MiniAODv2/HAHMHToAA_AToGG_MA-50GeV_TuneCP5_PSweights_13TeV-madgraph_pythia8/MINIAODSIM/PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/120000/FCCABD08-BEF4-EA11-912B-2000010DFE80.root"))
#process.source = cms.Source("PoolSource",
